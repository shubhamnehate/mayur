...
Operational hardening steps, security controls, manual payment/teacher onboarding workflows, and Google Sign-In setup are documented in [`docs/PRODUCTION_READINESS.md`](docs/PRODUCTION_READINESS.md).
